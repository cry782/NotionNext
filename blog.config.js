...
const BLOG = {
  ...
  BIO: process.env.NEXT_PUBLIC_BIO || '一个专注跨境电商的外贸人', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.1688333.xyz', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '跨境电商, 外贸', // 网站关键词 英文逗号隔开
  ...
  GREETING_WORDS:
    ...
    'Hi，我是一个程序员, Hi，我是一个外贸人,Hi，我是一个跨境电商人,欢迎来到我的博客🎉',
